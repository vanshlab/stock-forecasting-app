...
# ✅ Set API Key
API_KEY = "nixak-oe7kXV1rgAfSGBESpowggRA5m2HnKmKc8CFECAxEsqIC5lErcroQRw2htfndCFLEnZ60DBacHGwfOvfr"
if not API_KEY:
...
def forecast_stock(symbol):
    ...
    try:
        forecast_df = tgt.forecast(df=data, h=30, time_col="ds", target_col="y")
